 ...
 */
final class Version20240412122228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE kanban_label (id INT AUTO_INCREMENT NOT NULL, label_name VARCHAR(32) DEFAULT NULL, created_at DATETIME NOT NULL, label_color VARCHAR(32) NOT NULL, update_at DATETIME DEFAULT NULL, status VARCHAR(24) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kanban_label_history (id INT AUTO_INCREMENT NOT NULL, entity_id INT NOT NULL, event VARCHAR(66) NOT NULL, created_at DATETIME NOT NULL, status VARCHAR(24) NOT NULL, INDEX IDX_2A46569781257D5D (entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE kanban_label_history ADD CONSTRAINT FK_2A46569781257D5D FOREIGN KEY (entity_id) REFERENCES kanban_label (id)');
    }
